...
schema = {
    ...
    "percentage_sale": {"type": "float", "required": True, "description": "Float porcentagem de venda."},
    "update_price": {"type": "boolean", "required": True, "description": "Atualizar preço de venda baseado na porcentagem. True/False"},
